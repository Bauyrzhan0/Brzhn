import os
print("Привет всем кто смотрит мой код!")
while True:
    k=int(input("\nЧто ты хочешь? Поработать с файлами(1) или папками(2) ? "))
    path=os.getcwd()
    if k==1:
        oldname=input("Как называется твой файл, пиши вместе с форматом: ")
    ...
    """))
        ...
        if num==1:
            ...
            print("Путь из папок в котором находиться файл")
